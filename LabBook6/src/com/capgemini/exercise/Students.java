...
public class Students {
	...
	public static void main(String[] args) {
		...
		int size=sc.nextInt();
		if(size<1)
			System.out.println("Minimum Strength of class should be 1 or more.");
		else {
			...
			System.out.print("The registration number of the students along with the corresponding medal types:");
